...
**Generated**: June 30, 2026 (06:55 UTC)  
...
|-------|------------|------------|-----------------|
| Shopify API Key reference truncated (`apiKey: proces...KEY`) | 🔴 Critical | 5 min | `app/lib/shopify/server.ts` line 7 |
...
*This report is generated hourly by the StockFlows Enhancement Loop. Next run: 07:00 UTC*