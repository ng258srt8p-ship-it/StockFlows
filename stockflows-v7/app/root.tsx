...
export default function App() {
  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased" style={{ fontFamily: "var(--font-sans)", backgroundColor: "var(--bg-primary)", color: "var(--text-primary)" }}>
        <AppProvider i18n={i18n}>
          {isLoading && (
            <div className="fixed top-0 left-0 right-0 h-1 animate-pulse z-50" style={{ backgroundColor: "var(--accent-primary)" }} role="progressbar" aria-label="Loading" aria-busy="true" />
          )}
          <Outlet />
        </AppProvider>
        <ScrollRestoration />
